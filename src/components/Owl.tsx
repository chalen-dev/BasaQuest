...
export const Owl: React.FC<OwlProps> = ({ mood = 'greeting', size = 64, bob = false, className = '' }) => {
    ...
    return (
        ...
        >
            ...
            <path d="M84 184 l-6 8 M84 184 l0 9 M84 184 l6 8" stroke="#f0a91f" strokeWidth="3" strokeLinecap="round" fill="none" />
            <path d="M116 184 l-6 8 M116 184 l0 9 M116 184 l6 8" stroke="#f0a91f" strokeWidth="3" strokeLinecap="round" fill="none" />
