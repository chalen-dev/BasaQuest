...
import { Shield, Mic, BookOpen } from 'lucide-react'
...
const STRINGS: Record<Lang, {
    ...
    fil: {
        ...
        tracks: {
            ...
            proficiency: {
                kicker: 'Track 2 · Pagbasa nang Malakas',
            ...
            comprehension: {
                kicker: 'Track 3 · Pag-unawa sa Binasa',
    ...
    en: {
        ...
        tracks: {
            ...
            comprehension: {
                kicker: 'Track 3 · Reading Comprehension',
                ...
                {TRACK_META.map((meta) => {
                    ...
                    return (
                        <button
                            ...
                            className="flex flex-col overflow-hidden rounded-2xl border-2 border-gray-900/5 bg-white text-left shadow-sm transition-transform duration-200 hover:-translate-y-0.5 hover:shadow-md dark:border-gray-100/10 dark:bg-gray-900"
                        >
                            <div className="relative h-32 overflow-hidden">
                                <TrackScene name={meta.id} className="absolute inset-0 h-full w-full" />
                                <span className="absolute left-3 top-3 flex h-11 w-11 items-center justify-center rounded-2xl bg-white/90 shadow-sm">
                            ...
                            <div className="flex flex-1 flex-col gap-2 p-5">
                                ...
                                <span className={`w-fit rounded-full px-5 py-2 text-sm font-bold text-white transition-[transform,box-shadow] duration-150 ${colors.button}`}>
                                    {t.enter} →
                                </span>
                            </div>
                        </button>
