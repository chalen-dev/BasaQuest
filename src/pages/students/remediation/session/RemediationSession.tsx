...
import { CheckCircle2, ChevronLeft, ChevronRight, Circle, PartyPopper } from 'lucide-react'
            ...
            <div className="mx-auto max-w-2xl px-4 pb-12 pt-2">
                <section className="flex flex-col items-center gap-3 rounded-3xl border border-gray-900/5 p-8 text-center shadow-sm dark:border-gray-100/10">
                    ...
                    <button
                        type="button"
                        onClick={goBack}
                        className="mt-2 rounded-full border border-gray-900/10 bg-white px-5 py-2 text-sm font-bold text-gray-700 shadow-sm dark:border-gray-100/10 dark:bg-gray-900 dark:text-gray-200"
                    >
                        {t.backButton}
                    </button>
                </section>
            ...
            <div className="mx-auto max-w-2xl px-4 pb-12 pt-2">
                <section className="flex flex-col items-center gap-4 rounded-3xl border border-purple-500/25 bg-purple-500/5 p-10 text-center shadow-sm dark:border-purple-400/25 dark:bg-purple-400/5">
                    ...
                    <button
                        type="button"
                        onClick={goBack}
                        className="mt-2 flex items-center gap-2 rounded-full bg-purple-500 px-6 py-2.5 text-sm font-bold text-white shadow-[0_4px_0_0_#6d28d9] transition-[transform,box-shadow] duration-150 hover:-translate-y-0.5 active:translate-y-0 active:shadow-[0_1px_0_0_#6d28d9] dark:bg-purple-600 dark:shadow-[0_4px_0_0_#5b21b6]"
                    >
                    ...
                    {words.map((w, i) => {
                        ...
                        return (
                            <button
                                ...
                                className={`flex items-start gap-2.5 rounded-xl px-3 py-3 text-left text-base font-bold transition-colors duration-150 ${rowClasses}`}
                            >
            ...
            <div className={CONTENT_OFFSET_CLASS}>
                <div className="mx-auto max-w-3xl px-4 pb-14 pt-4">
                    <div className="flex flex-col gap-6 rounded-[2rem] border border-gray-900/10 bg-white/80 p-6 shadow-xl backdrop-blur-md dark:border-gray-100/10 dark:bg-gray-950/70 sm:p-10">
                        ...
                        <section className="flex min-h-[24rem] flex-col items-center justify-center gap-8 rounded-3xl border border-gray-900/5 bg-white p-10 text-center shadow-sm dark:border-gray-100/10 dark:bg-gray-900 sm:min-h-[28rem] sm:p-16">
                            ...
                            <button
                                ...
                                className={`flex items-center gap-2.5 rounded-full px-8 py-4 text-base font-bold shadow-sm transition-colors duration-200 ${
                                    isCurrentPracticed
                            ...
                            >
                                {isCurrentPracticed ? <CheckCircle2 size={22} /> : <Circle size={22} />}
                        ...
                        <div className="flex items-center justify-between gap-3">
                            ...
                            {currentIndex === words.length - 1 ? (
                                <button
                                    ...
                                    className="flex items-center gap-2 rounded-full bg-purple-500 px-8 py-3 text-sm font-bold text-white shadow-[0_4px_0_0_#6d28d9] transition-[transform,box-shadow] duration-150 hover:-translate-y-0.5 active:translate-y-0 active:shadow-[0_1px_0_0_#6d28d9] dark:bg-purple-600 dark:shadow-[0_4px_0_0_#5b21b6]"
                                >
                                    {t.finish}
                                </button>
                            ) : (
                                <button
                                    ...
                                    className="flex items-center gap-1.5 rounded-full bg-purple-500 px-7 py-3 text-sm font-bold text-white shadow-[0_4px_0_0_#6d28d9] transition-[transform,box-shadow] duration-150 hover:-translate-y-0.5 active:translate-y-0 active:shadow-[0_1px_0_0_#6d28d9] dark:bg-purple-600 dark:shadow-[0_4px_0_0_#5b21b6]"
                                >
                                    {t.next}
                        ...
                        <button
                            ...
                            className="text-center text-xs font-bold text-gray-400 underline-offset-2 transition-colors duration-200 hover:text-gray-600 hover:underline dark:text-gray-500 dark:hover:text-gray-300"
                        >
                            {t.endEarly}
                        </button>
                    </div>
